...
public class CommentServiceImpl implements CommentService {
    ...
    public List<Comment> getCommentsByEssayId(String essayId) {
        LogUtils.LogInfo("CommentServiceImpl.getCommentsByEssayId", Thread.currentThread().getStackTrace()[1].getFileName(), Thread.currentThread().getStackTrace()[1].getLineNumber(), new Date());
    ...
    public boolean addNewComment(Comment comment) {
        LogUtils.LogInfo("CommentServiceImpl.addNewComment", Thread.currentThread().getStackTrace()[1].getFileName(), Thread.currentThread().getStackTrace()[1].getLineNumber(), new Date());
    ...
    public boolean deleteCommentById(String id) {
        LogUtils.LogInfo("CommentServiceImpl.deleteCommentById", Thread.currentThread().getStackTrace()[1].getFileName(), Thread.currentThread().getStackTrace()[1].getLineNumber(), new Date());
        try {
            try {
